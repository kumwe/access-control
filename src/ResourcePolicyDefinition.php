...
final readonly class ResourcePolicyDefinition
{
    ...
    public function __construct(
        ...
        foreach ($systemIdentities as $identity) {
            if (++$consumed > 64 || preg_match('/^system:[a-z][a-z0-9-]{0,62}$/D', $identity) !== 1) {
                throw new InvalidArgumentException('A system identity must be a bounded neutral system code.');
            }
     ...
     * @since  0.1.0
     */
    public function allowsSystemIdentity(string $identity): bool
    {
    ...
    public function toArray(): array
    {
        return [
            ...
            'system_identities' => $this->systemIdentities,
